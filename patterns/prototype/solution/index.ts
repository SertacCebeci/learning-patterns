...
console.log("\n=== Independence check ===");
console.log(`  Report template styles count: ${reportTemplate.styles.length} (should be 3)`);
console.log(`  Sales report styles count: ${salesReport.styles.length} (should be 4)`);
console.log(`  Memo template has "author" key: ${"author" in memoTemplate.metadata} (should be false)`);
console.log(`  Urgent memo has "author" key: ${"author" in urgentMemo.metadata} (should be true)`);
console.log(`  salesReport instanceof Document: ${salesReport instanceof Document} (should be true)`);
