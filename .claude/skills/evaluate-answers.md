...
description: Use when user invokes /evaluate-answers with a pattern name to compare their answer against the reference solution for a design pattern exercise
---
